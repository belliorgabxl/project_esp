...
//       const selectedTypeData = customizeBtn[selectedType as keyof CustomizeBtnType];
  
//       if (selectedType === "transmiter" && selectedCategory in selectedTypeData) {
//         selectedData = selectedTypeData[selectedCategory as keyof typeof selectedTypeData];
//       } else if (selectedType === "reciever" && selectedCategory in selectedTypeData) {
//         selectedData = selectedTypeData[selectedCategory as keyof typeof selectedTypeData];
//       }
//     }
