...
//   const [checkConnected, setCheckConnected] = useState<string | null>(null);
...
//   const [Testconnect , setTestConnect] = useState<string>('');
//   const [bool , setBool] = useState(false);
//   const [testShow , SetTestShow] = useState<string | null>(null);
//   useEffect(() => {
...
//     //   setCheckConnected(message.toString());
//     // });
//     setClient(client);
//     return () => {
//       if (client) {
...
//       client.on("connect", () => {
//         if (topic != null) {
//           client.subscribe("esp32/roboticarm/1021", (err) => {
//             if (!err) {
...
//   const testPublish = ()=>{
//     if (client && isConnected ) {
//       client.publish("esp32/roboticarm/1021", "hello");
//       console.log("sending...")
//     }
//   }
...
//             }`}
//           >
//             Robotic Arm Controller {Testconnect}
//           </h1>
//         </span>
//         <button
...
//           />
//           <button className="px-10 py-4 bg-green-500 text-white active:shadow-inner active:shadow-black shadow-md shadow-gray-800 h-10" onClick={()=>setBool(bool=>!bool)}>Recieve</button>
//           <button className="px-10 py-4 bg-yellow-500 text-white active:shadow-inner active:shadow-black shadow-md shadow-gray-800 h-10" onClick={testPublish}>Send</button>
//           {testShow == "hello" ? (
