...
export default function AboutUsDetail({ isLoading }: Props) {
  return (
    <div className="grid w-full">
      ...
      >
        <div className="bg-gray-900 text-white px-10 py-5 hover:pr-40 duration-1000 rounded-lg">
      ...
      >
        <div className="bg-gray-900 text-white px-10 hover:px-40 duration-1000 py-5 rounded-lg">
      ...
      >
        <div className="bg-gray-900 text-white hover:px-40 duration-1000 px-10 py-5 rounded-lg">
